...
import { FaBoxOpen, FaClipboardList, FaShoppingBag, FaSignOutAlt, FaStore, FaUser } from 'react-icons/fa'
...
const AdminSidebar = () => {
    ...
    return (
        <div className='p-6 '>
            ...
            <div className='mt-6'>
                <button className='w-full bg-red-500  hover:bg-red-600 py-2 px-4 rounded flex items-center justify-center space-x-2 text-white' onClick={handleLogout}> <FaSignOutAlt></FaSignOutAlt> <span>Logout</span></button>
            </div>
        </div>
    )
}
