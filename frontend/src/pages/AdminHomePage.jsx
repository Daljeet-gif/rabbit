...
const AdminHomePage = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto p-6'>
            ...
            {productsLoading || orderLoading ? (<p>Loading...</p>) : productError ? (<p className='text-red-500'>Error fetching products:{productError}</p>) : ordersError ? (<p className='text-red-500'>Error fetching Orders:{ordersError}</p>) : (<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
