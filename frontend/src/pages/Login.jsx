        ...
        <div className='flex'>
            <div className='w-full md:w-1/2 flex-col justify-center items-center p-8 md:p-12'>
                <form onSubmit={handleSubmit} className='w-full max-w-md bg-white p-8 rounded-lg border shadow-sm '>
                    ...
                    <p className='mt-6 text-center text-sm'>
                        ...
                        <Link className='text-blue-500' to={`/register?redirect=${encodeURIComponent(redirect)}`}> Register</Link>
                    </p>
                </form>
            </div>
            ...
            <div className='hidden md:block w-1/2 bg-gray-800'>
                <div className='h-full flex flex-col justify-center items-center'>
                    <img src={login} alt='Login to Account' className='h-[750px] w-full object-cover'></img></div></div>
        </div>
    )
}
